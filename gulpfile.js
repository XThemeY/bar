...
exports.dist = gulp.series(clear.dist, gulp.parallel(pug.dist, scss.dist, script.dist,libs.dist, gulp.series(svg, imageMinify.dist), fonts.dist), gulp.parallel(server))
